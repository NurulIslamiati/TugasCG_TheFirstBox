...
public class Visualloop extends Application implements Runnable {
    ...
    float cx = 300;
    float cy = 300;
    Image image = new Image (getClass().getResourceAsStream("tes.jpg"));
    ...
    public void start (Stage primaryStage){
        ...
        public void handle (MouseEvent e){
         ...
         primaryStage.getIcons().add(new Image (getClass().getResourceAsStream("toooo.jpg")));
    ...
    private void draw(){
        try{
            if (canvas != null) {
                ...
                if(inputKeyboard.contains("P")){//Gerak kotsk akan berhenti saat Key P ditekan
                    gc.setTextAlign(TextAlignment.CENTER);
                    gc.fillText("INFORMATIKA", cx, cy);
                }
